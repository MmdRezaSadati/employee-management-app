...
const OverviewSection: FC<{ caption: string }> = ({ caption }) => {
  return (
    <div className="box-border h-56 w-full overflow-hidden overflow-y-auto bg-white p-5 text-sm leading-6 text-slate-800 dark:bg-black-light/5 dark:text-slate-200">
